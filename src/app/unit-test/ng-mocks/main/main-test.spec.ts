...
//         console.log('1111111111 header', header)
//         /*
//         DebugElement__POST_R3__{nativeNode: <app-header ng-reflect-show-logo="true" 
//         ng-reflect-title="Fake Application"><!--container--><div data-key="menu"><ul><li><a ng-reflect-router-link="/home">fake:Home</a><!--container--></li><li><a ng-reflect-router-link="/about">fake:About</a><!--container--></li></ul><!--container--></div><!--bindings={
//           "ng-reflect-ng-if": "true"
//         }--><!--bindings={}--></app-header>}
//         */
//         // Verifies how AppComponent uses AppHeaderComponent.
//         const herderComponent = header.componentInstance;
