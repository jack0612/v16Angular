...
//https://medium.com/@krishnaagrawal_90548/angular-2-number-only-directive-86dfaab4f3c7
@Directive({
  selector: '[digitOnly]',
})
export class DigitalOnlyDirective implements OnChanges {
  ...
  onKeyDown(e: KeyboardEvent): any {
    ...
    console.log('111',{newValue,forcastValue:this.forecastValue(e.key)})
  ...
  private forecastValue(key: string): string {
    ...
    let p1=  oldValue.substring(0, selectionStart) 

    let p2=oldValue.substring(selectionStart)
    let newValue=p1+key +p2;
    console.log('===',{selectionStart,selectionEnd,oldValue,selection,p1,p2,newValue})
